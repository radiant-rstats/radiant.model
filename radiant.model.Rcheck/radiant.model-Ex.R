...
### Name: plot.uplift
### Title: Plot method for the uplift function
### Aliases: plot.uplift
...
cleanEx()
nameEx("summary.uplift")
### * summary.uplift

flush(stderr()); flush(stdout())

### Name: summary.uplift
### Title: Summary method for the uplift function
### Aliases: summary.uplift
...
### Name: uplift
### Title: Evaluate uplift for different (binary) classification models
### Aliases: uplift
