...
#'
#' @details See \url{http://radiant-rstats.github.io/docs/model/crtree.html} for an example in Radiant
#'
...
#'
#' @details See \url{http://radiant-rstats.github.io/docs/model/crtree.html} for an example in Radiant. The standard tree plot used by by the rpart package can be generated by \code{plot.rpart(result$model)}. See \code{\link{plot.rpart}} for additional details.
#'
