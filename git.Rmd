...
## checking out works without 
system("git checkout summarize-early")

## push new branch to github - works - equivalent in git2r?
...
system("git merge summarize-early")
system("git merge eval-regression")

system("git branch -d summarize-early")
system("git branch -d eval-regression")
